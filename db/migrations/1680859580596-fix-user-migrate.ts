...
export class fixUserMigrate1680859580596 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "account" ALTER COLUMN "createAt" SET DEFAULT '2023-04-07T09:26:21.567Z'`,
    );
    await queryRunner.query(
      `ALTER TABLE "review" DROP CONSTRAINT "FK_690a6193eae64156895920ddcd3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "review" ALTER COLUMN "reviewDate" SET DEFAULT '2023-04-07T09:26:21.570Z'`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "review" ALTER COLUMN "reviewDate" SET DEFAULT '2023-04-06 04:19:58.064'`,
    );
    await queryRunner.query(
      `ALTER TABLE "review" ADD CONSTRAINT "FK_690a6193eae64156895920ddcd3" FOREIGN KEY ("userAccountId") REFERENCES "user"("accountId") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "account" ALTER COLUMN "createAt" SET DEFAULT '2023-04-06 04:19:57.905'`,
    );
  }
}
